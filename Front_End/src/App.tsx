...
const CartSessionSync = () => {
  ...
  useEffect(() => {
    const nextOwnerKey =
      isAuthenticated && userId ? buildCartOwnerKey(userId) : GUEST_CART_OWNER;
