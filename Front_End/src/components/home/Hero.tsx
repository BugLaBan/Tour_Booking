      ...
      <div className="container relative z-10 text-center text-white px-4">
        ...
        >
          ...
          <span className="text-secondary">
            Tim hanh trinh phu hop ngay hom nay
          </span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          Tim nhanh tour theo diem den, ngay khoi hanh va so luong hanh khach.
          Ket qua se duoc loc truc tiep tu API that cua he thong.
        </motion.p>
