...
const updateQuantity = (value: number, delta: number, minimum: number) =>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative">
            <select
              ...
              onChange={(event) =>
                onChange({ ...filters, departure: event.target.value })
              }
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative">
            <select
              ...
              onChange={(event) =>
                onChange({ ...filters, priceRange: event.target.value })
              }
              className="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 appearance-none"
            >
