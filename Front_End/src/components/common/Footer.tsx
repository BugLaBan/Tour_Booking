        ...
        <div className="bg-primary rounded-2xl p-8 md:p-12 mb-16 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-white max-w-md">
            ...
            <p className="opacity-80">
              Nhận thông tin về các tour mới nhất và ưu đãi hấp dẫn hàng tuần.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              28.TRAVEL tự hào là đơn vị cung cấp các tour du lịch chất lượng
              cao, mang đến trải nghiệm tuyệt vời cho khách hàng trên mọi hành
              trình.
            </p>
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-gray-600 hover:bg-primary hover:text-white transition-all"
              >
                <Facebook size={20} />
              </a>
              <a
