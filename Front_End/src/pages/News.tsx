    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="container">
        <div className="max-w-3xl mb-10">
          <h1 className="text-4xl font-black text-primary uppercase mb-4">
            Tin Tuc Du Lich
          </h1>
          <p className="text-gray-600 leading-relaxed">
            Cac bai viet duoc tao tu du lieu tour thuc te tren he thong, giup
            ban nhanh chong nam duoc lich khoi hanh, muc gia va nhung hanh trinh
            dang duoc quan tam.
          </p>
        </div>
            ...
            {articles.map((article) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mb-4 text-sm leading-6 text-gray-600 line-clamp-4">
                    {article.excerpt}
                  </p>
                  <Link
                    to={article.path}
